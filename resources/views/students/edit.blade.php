...
<main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
    <section>
        <h3 class="font-bold text-2xl">Student Informations:</h3>
    </section>
    <section class="mt-10">
        ...
        <form action="/student/{{ $student->id }}" method="POST">
            @method('delete')
            @csrf
            <button type="submit" class="w-full bg-rose-600 hover:bg-rose-700 text-white font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">DELETE</button>
        </form>
    </section>
</main>
