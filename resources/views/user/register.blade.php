        ...
        <section class="mt-10">
            <form action="/store" method="POST" class="flex flex-col">
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    ...
                    <input type="text" name="name" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off" value="{{ old('name') }}">
                    @error('name')
                ...
                <div class="mb-6 pt-3 rounded bg-gray-200">
                    ...
                    <input type="password" name="password_confirmation" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3" autocomplete="off">
